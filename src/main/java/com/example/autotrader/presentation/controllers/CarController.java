...
public class CarController {
     ...
     */
    @GetMapping("/search")
    public ResponseEntity<ApiResponse<CarListResponseDto>> searchCars(
        ...
        // Execute search - returns Either<Failure, CarListResponseDto>
        Either<Failure, CarListResponseDto> result = getCarListUseCase.execute(criteria);
